 ...
 * @since 4.2.2
 */
public class JSONConverter1 implements Converter<JSON> {

	static {
		// 注册到转换中心
		final ConverterRegistry registry = ConverterRegistry.getInstance();
		registry.putCustom(JSON.class, JSONConverter1.class);
		registry.putCustom(JSONObject.class, JSONConverter1.class);
		registry.putCustom(JSONArray.class, JSONConverter1.class);
	}
